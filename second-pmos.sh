...
echo "Setting up Flatpak and installing GoofCord (Discord Client for Linux, supporting ARM64 & x86_64), VSCode, Brave Browser, Fedora Media Writer, Github Desktop, and Minecraft Pi..."
