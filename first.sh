...
sudo apt install totem eog mousepad file-roller atril gnome-disk-utility gnome-system-monitor system-config-printer cups gnome-core telegram-desktop network-manager-gnome gnome-tweaks --no-install-recommends -y
