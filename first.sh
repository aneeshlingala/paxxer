...
sudo apt install totem eog mousepad file-roller atril gnome-disk-utility gnome-system-monitor mate-applets mate-screensaver system-config-printer cups mate-desktop-environment-core telegram-desktop network-manager-gnome mate-calc mate-applet-brisk-menu mate-tweak --no-install-recommends -y
