...
sudo apt install kde-plasma-desktop gwenview simplescreenrecorder file-roller atril plasma-systemmonitor cups telegram-desktop network-manager-gnome kcalc -y
