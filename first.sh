...
sudo apt install totem eog mousepad file-roller atril nemo gnome-disk-utility gnome-system-monitor alacritty phosh phosh-core gnome-tweaks --no-install-recommends -y
