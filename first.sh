...
sudo apt install totem eog mousepad file-roller atril nemo gnome-disk-utility gnome-system-monitor gnome-terminal mate-desktop-environment-core telegram-desktop network-manager-gnome mate-calc --no-install-recommends -y
