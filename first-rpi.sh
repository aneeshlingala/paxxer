...
echo "Installing KDE..."
sudo apt install gwenview simplescreenrecorder file-roller atril plasma-systemmonitor cups network-manager-gnome kcalc kde-plasma-desktop --no-install-recommends -y
