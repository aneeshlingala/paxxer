...
ln -s /usr/share/themes/vimix-dark-doder/gtk-4.0/gtk.css ~/.config/gtk-4.0/gtk.css
ln -s /usr/share/themes/vimix-dark-doder/gtk-4.0/gtk-dark.css ~/.config/gtk-4.0/gtk-dark.css
ln -s /usr/share/themes/vimix-dark-doder/gtk-4.0/assets ~/.config/gtk-4.0/assets
ln -s /usr/share/themes/vimix-dark-doder/assets ~/.config/assets
echo "GTK_THEME=vimix-dark-doder " | sudo tee -a /etc/environment
cd ~
